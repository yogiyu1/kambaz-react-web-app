...
tag to tell browsers to render the gaps.
        ...
        My favorite recipe - Steam Egg:
        <ol id="wd-your-favorite-recipe">
            <li> Prepare the Egg Mixture</li>
            <li> Strain the Mixture</li>
            <li> Prepare the Steaming Bowl</li>
            <li> Steam the Eggs</li>
  ...
  <li>The Forever War</li>
        ...
        Xiaojun's favorite books (in no particular order)
        <ul id="wd-your-books">
  ...
  <img id="wd-teslabot" src="images/teslabot.jpg" height="200px" />
        ...
        <textarea id="wd-textarea" cols={30} rows={10}>Lorem ipsum dolor sit amet, 
            ...
            sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
             ...
             in voluptate veligiat nulla pariatur.
             t esse cillum dolore eu fu
